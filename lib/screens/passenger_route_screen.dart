...
class PassengerRouteScreen extends StatefulWidget {
  const PassengerRouteScreen({super.key});

  @override
  State<PassengerRouteScreen> createState() => _PassengerRouteScreenState();
}

class _PassengerRouteScreenState extends State<PassengerRouteScreen>
  ...
  // New fields for departure date, time, and vehicle type
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildStaggeredFormField(0, _buildFromField()),
                                const SizedBox(height: 20),

                                _buildStaggeredFormField(1, _buildToField()),
                                const SizedBox(height: 20),

                                _buildStaggeredFormField(
                                    2, _buildContactField()),
                                const SizedBox(height: 20),

                                _buildStaggeredFormField(3, _buildNameField()),
                                const SizedBox(height: 20),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Tell us your journey details to find the perfect ride',
              style: TextStyle(
  ...
  Widget _buildFromField() {
    return _buildEnhancedFormField(
      ...
      onTap: () {
        _showLocationSuggestions('', _fromController);
      },
      validator: (value) {
  ...
  Widget _buildToField() {
    return _buildEnhancedFormField(
      ...
      icon: Icons.flag,
      onTap: () {
        _showLocationSuggestions('', _toController);
      },
      validator: (value) {
        if (value == null || value.isEmpty) {
                        ...
                        await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => MapScreen(
                              ...
                              availableSeats:
                                  null, // Passengers don't specify seats
                              isRider:
                                  false, // Flag to indicate this is for passenger
                            ),
                          ),
                        );
