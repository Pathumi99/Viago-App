...
import 'rider_requests_screen.dart';
...
class _RiderHomeScreenState extends State<RiderHomeScreen>
  ...
  // Enhanced Drawer/Sidebar for Rider
                    ...
                    _buildDrawerItem(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const RiderRouteScreen(),
                          ),
                        );
                      },
                    ),
                    _buildDrawerItem(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const RiderRequestsScreen(),
                          ),
                        );
                      },
                    ),
                    _buildDrawerItem(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const SafetyCenterScreen(userType: 'rider'),
                          ),
                        );
                      },
                    ),
  ...
  Widget _buildQuickStatsSection() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildStatItem(
              'Rides Shared', '0', Icons.directions_car, Colors.orange),
          _buildStatItem('Earnings', 'Rs 0', Icons.attach_money, Colors.green),
          _buildStatItem('Rating', '5.0', Icons.star, Colors.amber),
        ],
      ),
    );
  }
  ...
  Widget _buildRideRequestsCard() {
    return EnhancedGlassCard(
      ...
      subtitle: 'Manage passenger requests',
      gradient: LinearGradient(
        colors: [
  ...
  Widget _buildSafetyCenterCard() {
    return EnhancedGlassCard(
      icon: Icons.shield,
      label: 'Driver Safety Center',
      subtitle: 'Your safety tools and resources',
      gradient: LinearGradient(
        colors: [
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const SafetyCenterScreen(userType: 'rider'),
          ),
        );
      },
    );
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'ViaGo Rider - Share, earn, and connect',
                  style: TextStyle(
                    color: Colors.white.withValues(alpha: 0.9),
                    fontSize: 14,
                    fontWeight: FontWeight.w500,
